...
freq_press_mic_1 = [dlmread('Microphone_1_sound_pressure.txt')];

freq_press_mic_2 = [dlmread('Microphone_2_sound_pressure.txt')];

freq_press_mic_3 = [dlmread('Microphone_3_sound_pressure.txt')]; 
